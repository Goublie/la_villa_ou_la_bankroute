...
public class EpargneUI : MonoBehaviour
{
    ...
    public void ActualiserTableau()
    {
        ...
        tableauEpgn.nombreColonnes = 4;
        tableauEpgn.largeursColonnes = new System.Collections.Generic.List<float> { 200f, 150f, 150f, -1f };
        tableauEpgn.AppliquerStructure();

        Historique historique = epgn.GetHistorique();
        tableauEpgn.Vider();
        tableauEpgn.GarantirLignesMinimum();
        ...
        for (int i = historique.GetSize() - 1; i >= 0; i--)
        {
            ...
            tableauEpgn.Add(t.libelle, dateStr, creditStr, debitStr);
        }
    }
